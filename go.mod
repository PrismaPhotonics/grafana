...
require (
	...
	golang.org/x/net v0.54.0 // @grafana/oss-big-tent @grafana/partner-datasources
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20250428153025-10db94c68c34 // indirect; @grafana/plugins-platform-backend
...
require github.com/grafana/authlib/types v0.0.0-20260707082819-467781b5f1d6
