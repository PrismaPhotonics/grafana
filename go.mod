...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20260217215200-42d3e9bedb6d // indirect; @grafana/plugins-platform-backend
...
require github.com/grafana/authlib/types v0.0.0-20260316143530-e1d123886039
