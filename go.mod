...
require (
	...
	github.com/grafana/alerting v0.0.0-20250220140557-be46240a1eda // @grafana/alerting-backend
	...
	github.com/grafana/dskit v0.0.0-20250917065751-798f5a8fa154 // @grafana/grafana-backend-group
	github.com/grafana/gofpdf v0.0.0-20231002120153-857cc45be447 // @grafana/sharing-squad
	github.com/grafana/gomemcache v0.0.0-20250828162811-a96f6acee2fe // @grafana/grafana-operator-experience-squad
	...
	github.com/prometheus/common v0.65.1-0.20250703115700-7f8b2a0d32d3 // @grafana/alerting-backend
	github.com/prometheus/prometheus v0.305.1-0.20250806170547-208187eaa19b // @grafana/alerting-backend
	github.com/redis/go-redis/v9 v9.10.0 // @grafana/alerting-backend
	...
	golang.org/x/exp v0.0.0-20250711185948-6ae5c78190dc // @grafana/alerting-backend
...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20251002232023-7c0ddcbb5797 // indirect; @grafana/plugins-platform-backend
...
require github.com/grafana/loki/v3 v3.6.4 // @grafana/observability-logs
...
require github.com/grafana/authlib/types v0.0.0-20260414201248-d766c8627a66
...
// Pin these because their combination has breaking changes otherwise.
replace (
