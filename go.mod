...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20260406210006-6f92a3bedf2d // indirect; @grafana/plugins-platform-backend
...
require github.com/grafana/authlib/types v0.0.0-20260417044529-7cb21b702aef
