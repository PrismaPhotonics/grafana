...
require (
	...
	google.golang.org/genproto/googleapis/rpc v0.0.0-20251222181119-0a764e51fe1b // indirect; @grafana/plugins-platform-backend
...
require github.com/grafana/authlib/types v0.0.0-20260203153107-16a114a99f67
