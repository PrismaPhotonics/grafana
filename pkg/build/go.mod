...
replace github.com/docker/docker => github.com/moby/moby v27.4.1+incompatible
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.69.0 // indirect; @grafana/plugins-platform-backend
	...
	golang.org/x/crypto v0.51.0 // indirect; @grafana/grafana-backend-group
